...
const Seller_Wallet = () => {
    ...
    <div className="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 flex w-full justify-center items-center">
        ...
        <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism bg-gradient-to-r from-yellow-300 to-green-600">
        ...
        <div className="flex flex-col items-start justify-start py-12 px-4">
            <button type="button" onClick={connectWallet} className="flex flex-row justify-center items-center my-5 bg-yellow-300 p-3 rounded-full cursor-pointer hover:bg-green-600">
